...
def deploy_prompt(workspace_root: str) -> str:
    ...
    return (
        ...
        "/ PRESERVE / DEACTIVATED / UNCHANGED) and list the files that would change. Call "
        "out any CONFLICT and PROTECT files explicitly. DEACTIVATED files are skills the "
        "project turned off (moved to `_available/`) — they are intentionally not deployed.\n"
