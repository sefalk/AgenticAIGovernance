...
description: Architect reliable data movement and transformation systems — ETL vs ELT, orchestration tools, batch/stream/lambda patterns, idempotency, error handling, and pipeline testing.
argument-hint: '[pattern: etl|elt|stream|batch] [focus: design|orchestration|testing|error-handling]'
---
...
- When designing ETL/ELT pipelines for data ingestion and transformation
- When selecting orchestration tools (Airflow, Dagster, dbt)
- When implementing error handling, retries, or dead letter queues
- When testing pipeline correctness and data freshness
...
- **Verifiability:** Pipeline correctness must be programmatically verifiable via data quality checks.
