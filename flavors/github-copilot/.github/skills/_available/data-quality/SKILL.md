---
name: data-quality
description: Ensure data is accurate, complete, consistent, timely, and fit for purpose — validation frameworks, anomaly detection, data contracts, SLAs, and quality dimensions.
argument-hint: '[dimension: completeness|accuracy|consistency|timeliness|uniqueness] [tool: great-expectations|dbt|soda|pandera]'
---
...
- When building data validation into pipelines
- When defining quality SLAs and data contracts
- When investigating data anomalies or drift
- When choosing validation tooling (Great Expectations, dbt tests, Soda, Pandera)
...
- **Verifiability:** Every data quality assertion must be programmatically verifiable.
- **Transparency:** Quality check results must be documented and accessible.
