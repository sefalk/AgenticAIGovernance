...
description: Systematically identify, assess, and mitigate project risks — risk registers, scoring matrices, response strategies, contingency planning, and review cadence.
argument-hint: '[focus: identify|assess|mitigate|review] [scope: project|technical|security]'
---
...
- When planning projects and identifying potential threats
- When conducting risk assessments or defining governance workflows
- When building contingency plans for high-impact risks
...
- **Fail-Safe:** When risk materializes and the situation is uncertain, halt and ask.
- **Transparency:** All identified risks, their assessments, and mitigation plans must be documented and visible.
