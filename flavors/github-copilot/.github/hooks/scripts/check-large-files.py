...
def main() -> int:
    ...
    print()
    print("To fix:")
    print("  - Reduce the file size: export interactive HTML by reference (CDN/URL), not")
    print('    self-contained (e.g. Plotly include_plotlyjs="cdn"). See the notebook-execution')
    print("    skill (Artifact Weight Hygiene) for library-agnostic guidance.")
