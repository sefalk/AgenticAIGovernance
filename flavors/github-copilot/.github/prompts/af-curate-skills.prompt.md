...
If `af-env.conf` is missing, halt and ask the user to run `/af-onboard-project` first.
...
1. Read `skills/curated-assignments.json`. If missing, halt with:
   "No curated-assignments.json found. Run /af-curate-skills first."
