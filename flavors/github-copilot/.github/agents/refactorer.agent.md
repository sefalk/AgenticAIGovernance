...
| Provenance markers on files you authored | HARD | Your Stop hook checks them against the authorship query — you do not self-certify, and reporting a marker you did not write is caught there | Standard+ |
