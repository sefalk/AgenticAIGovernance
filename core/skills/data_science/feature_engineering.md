...
related: [exploratory_data_analysis, model_evaluation, data_quality, data_modeling, ml_pipeline_design, model_selection]
---
# Feature Engineering

## Purpose

Feature engineering transforms raw data into informative representations that improve model performance and interpretability. It is the bridge between exploratory data analysis and model training. Invoke this skill when designing ML features, setting up feature stores, or defining Level-3 feature engineering workflows.

## Principles

- **Verifiability (AAIG L1):** Every feature must have a clear definition, derivation logic, and documented rationale. A feature without documentation is a liability.
- **Transparency (AAIG L1):** Feature derivation pipelines must be reproducible and auditable. No hand-crafted features that exist only in a lost notebook.
