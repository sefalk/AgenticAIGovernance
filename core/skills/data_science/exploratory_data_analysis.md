...
related: [feature_engineering, model_evaluation, data_quality, data_modeling, experiment_tracking, model_selection]
---
# Exploratory Data Analysis

## Purpose

Exploratory Data Analysis (EDA) is the systematic process of investigating datasets to discover patterns, spot anomalies, test hypotheses, and check assumptions before formal modeling. Invoke this skill when starting a new data science project, onboarding a new dataset, or validating data assumptions before model development.

## Principles

- **Verifiability (AAIG L1):** Every claim about the data must be backed by evidence -- a statistic, a visualization, or a test. No "I think the data looks normal" without a Shapiro-Wilk test or Q-Q plot.
- **Transparency (AAIG L1):** EDA findings must be documented in a reproducible artifact (notebook, report) so others can verify the conclusions.
